prompt = dict(
    outdoor=dict(
        ...
        pos_words=["fight", "punching", "seizing", "a fistfight of", "battle of", "assult of", "group fighting of", "gang fight of", "photo of fighting", "scene of fighting"],
        ...
        time_env = ['in daytime' , 'at night', 'in office'],
    ),
    elevator=dict(
        start=['there is', 'there are', 'a photo of', 'a scene of', ' '],
